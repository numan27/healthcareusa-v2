  ...
  return (
    <div className='position-relative'>
        ...
        <Box className="hero-content d-flex flex-column align-items-center h-100 w-100 py-5 px-lg-0 px-3">
          <Row className='py-sm-5 mt-md-5'>
            <Col className='mx-auto pt-sm-4'>
              <div>
                <Typography lineHeight="52px" align="center" className="mt-3 mb-0" as="h1" weight="800" color="#fff" size="40px">
                  Your One Stop Resource Directory of Healthcare
                </Typography>
                <Typography lineHeight="52px" align="center" className="" as="h1" weight="500" color="#fff" size="40px">
              ...
              <Row className='mt-3'>
                <Col className='mx-auto' md={6}>
                  <Box className="bg-white rounded-5 w-100 py-2">
      ...
      <div id="service-section" className='service-section container-xl container-fluid mt-lg-0 mt-5'>
        <Box className='bg-white mx-auto px-3' radius='16px 16px 0px 0px' height="40px">
          <Typography
            className="mb-0 pt-1"
            align="center"
            as="h2" weight="600"
        ...
        <Box width="100" className="custom-shadow mobile-padding bg-white" padding="30px 25px" radius="24px">
