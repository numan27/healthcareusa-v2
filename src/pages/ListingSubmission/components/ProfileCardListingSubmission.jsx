  ...
  return (
    <>
      <Box
        padding="8px 16px"
        height="30px"
        className="custom-border rounded-pill bg-white d-flex align-items-center gap-2 mx-auto mb-5"
      >
        <FaRegCircleDot size="18px" color="#FF5151" />
        <Typography
          weight="600"
          size="14px"
          font="SF Pro Display"
      ...
      <Box padding="16px" className="custom-border rounded bg-white w-100 mb-5">
        <Row>
          <Col
            lg={3}
            md={6}
              ...
              <div>
                ...
                <div className="d-flex align-items-center gap-2">
                  ...
                  <Typography
                    ...
                    lineHeight="16px"
                  >
                    {formData.languages?.join(", ") || "English, French"}
                  </Typography>
                </div>
