...
import { GenericButton, LinkButton, Typography } from '../../../../components/GenericComponents'
                ...
                <ul className='list-unstyled'>
                    {claimListingData.map((items) => (
                        <li className='d-flex align-items-center gap-2 mb-3'>
                            ...
                            <Typography as='h5' className='mb-0' color='#23262F' size='14px' lineHeight='21px' weight='500'>
                                {items.title}
                            </Typography>
                        </li>
                    ))}
