  ...
  return (
    <>
      {profile.map((data) => {
        ...
        const googleAddress =
          cubewpPostMeta["fc-google-address"]?.meta_value?.address || "";
        const phone = cubewpPostMeta["fc-phone"]?.meta_value || "";
        const languages = Array.isArray(
          cubewpPostMeta["fc-languages"]?.meta_value
        )
          ? cubewpPostMeta["fc-languages"]?.meta_value.join(", ")
          : cubewpPostMeta["fc-languages"]?.meta_value || "";
        const designation =
        ...
        return (
          ...
          >
            ...
            {enableSponsoredProfile && (
              ...
              >
                <GoDotFill
                  color={data.status === "Close" ? "#E91515" : "#00C1B6"}
                  size={16}
                />
                <Typography
                  as="span"
                  color={
                    data.status === "Close" ? "#E91515" : "#00C1B6"
                  }
                  weight="700"
                  size="16px"
                  lineHeight="24px"
